...
class AppDelegate: NSObject, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]? = nil) -> Bool {
        ...
        BaoziPlatform.bootstrapLocalRuntimeIfNeeded()
        LLog.bootstrap()
...
struct BaoziApp: App {
    ...
    var body: some Scene {
        ...
        mainWindowGroup
            ...
            .commands {
                BaoziCommands(appModel: appModel)
            }
        #else
        mainWindowGroup
        #endif
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        #if targetEnvironment(macCatalyst)
        .onReceive(NotificationCenter.default.publisher(for: .baoziCommandShowSettings)) { _ in
...
private struct HomeNavigationView: View {
    ...
    private var rootNavigationContent: some View {
        if BaoziPlatform.isRegularSurface(horizontalSizeClass: horizontalSizeClass) {
            splitRoot
        } else {
    ...
    var body: some View {
        ...
        #if targetEnvironment(macCatalyst)
        .onReceive(NotificationCenter.default.publisher(for: .baoziCommandNewSession)) { _ in
            handleNewSessionTap()
        }
        .onReceive(NotificationCenter.default.publisher(for: .baoziCommandNavigateBack)) { _ in
            if !navigationPath.isEmpty { navigationPath.removeLast() }
        }
        .onReceive(NotificationCenter.default.publisher(for: .baoziCommandNavigateForward)) { _ in
        ...
        .onReceive(NotificationCenter.default.publisher(for: .baoziCommandSelectSession)) { notification in
