...
enum VoiceSessionControl {
    ...
    static let defaultPrompt = "You are Codex in a live voice conversation inside Baozi. Keep responses short, spoken, and conversational. Avoid markdown and code formatting unless explicitly asked."
    ...
    static let endRequestDarwinNotification = "com.kris99.baozi.voice_session.end_request"
