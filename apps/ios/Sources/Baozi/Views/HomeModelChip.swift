        ...
        Button {
            ...
            HStack(spacing: 6) {
                ...
                Image(systemName: "cpu")
                    ...
                    .foregroundStyle(disabled ? BaoziTheme.textMuted : BaoziTheme.accent)
                Text(selectedModelLabel)
                    .baoziMonoFont(size: 12, weight: .semibold)
                    .foregroundStyle(disabled ? BaoziTheme.textSecondary : BaoziTheme.textPrimary)
                    .lineLimit(1)
                ...
                if isPlanMode {
                    Text("plan")
                        ...
                        .padding(.vertical, 1)
                        .background(BaoziTheme.accent, in: Capsule())
                }
                if isFullAccess {
