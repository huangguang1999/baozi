...
class ChatGPTOAuthLoopbackServerTest {
    ...
    fun successHtml_mentionsReturnToApp() {
        val html = ChatGPTOAuthLoopbackServer.successHtml("baoziauth://chatgpt-auth-complete")
        assertTrue(html.contains("Returning to Baozi"))
        assertTrue(html.contains("baoziauth://chatgpt-auth-complete"))
    }
}
