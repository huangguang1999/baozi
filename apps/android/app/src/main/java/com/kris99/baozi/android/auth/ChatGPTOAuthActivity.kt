package com.kris99.baozi.android.auth
...
import com.kris99.baozi.android.state.ChatGPTOAuthTokenBundle
...
class ChatGPTOAuthActivity : ComponentActivity() {
    ...
    companion object {
        const val ACTION_BROWSER_RETURN = "com.kris99.baozi.android.auth.CHATGPT_BROWSER_RETURN"
        ...
        Column(
            ...
            Text(
                text = if (browserOpened) {
                    ...
                    "Google blocks sign-in inside embedded web views, so Baozi uses your browser for this flow."
                },
