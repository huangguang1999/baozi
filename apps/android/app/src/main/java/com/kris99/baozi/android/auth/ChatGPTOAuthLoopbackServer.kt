...
import com.kris99.baozi.android.state.ChatGPTOAuthException
    ...
    companion object {
        ...
        internal fun successHtml(appReturnUri: String): String = """
            ...
            <head>
              ...
              <title>Baozi Login Complete</title>
            ...
            <body>
              <main>
                ...
                <p>Returning to Baozi. If nothing happens, <a href="$appReturnUri">tap here</a>.</p>
              </main>
            </body>
            </html>
        """.trimIndent()
