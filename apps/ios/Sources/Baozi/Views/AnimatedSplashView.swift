    ...
    var body: some View {
        ZStack {
            ...
            Image("brand_logo")
                .resizable()
                .scaledToFit()
                .frame(width: compact ? nil : 200, height: compact ? nil : 200)
        ...
        .onAppear { startDate = .now; breathing = true }
    }
    ...
    var body: some View {
        HStack(alignment: .center, spacing: 0) {
            SpinningWordCarousel(
                ...
                itemHeight: 18,
                fontSize: 14,
                selectedColor: BaoziTheme.textSecondary,
                dimColor: BaoziTheme.textMuted
            )
            ...
            ZStack(alignment: .trailing) {
                ForEach(Array(providers.enumerated()), id: \.element.id) { i, provider in
                    ...
                    HStack(spacing: 5) {
                        ...
                        Text(provider.label)
                            .baoziMonoFont(size: fontSize, weight: .regular)
