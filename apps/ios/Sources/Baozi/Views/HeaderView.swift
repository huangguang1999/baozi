...
struct HeaderView: View {
    ...
    private var primaryHeaderRow: some View {
        HStack(spacing: 6) {
            ...
            if fastMode {
                Image(systemName: "bolt.fill")
                    .font(BaoziFont.styled(size: 10, weight: .semibold))
        ...
        .font(BaoziFont.styled(size: 14, weight: .semibold))
        .lineLimit(1)
    ...
    private var secondaryHeaderRow: some View {
        HStack(spacing: 6) {
            Text(sessionDirectoryLabel)
                .font(BaoziFont.styled(size: 11, weight: .semibold))
                .foregroundColor(BaoziTheme.textSecondary)
                .lineLimit(1)
            ...
            if thread.collaborationMode == .plan {
                Text("plan")
                    .font(BaoziFont.styled(size: 11, weight: .bold))
    ...
    private var statusDotColor: Color {
        ...
        case .connected:
            ...
            return server.account == nil ? .orange : BaoziTheme.success
        case .disconnected:
            return BaoziTheme.danger
        case .unknown:
            return BaoziTheme.textMuted
    ...
    private var reloadButtonLabel: some View {
        if isReloading {
            ...
            Image(systemName: "arrow.clockwise")
                .font(BaoziFont.styled(size: 16, weight: .semibold))
                .foregroundColor(server?.isConnected == true ? BaoziTheme.accent : BaoziTheme.textMuted)
        }
    }
    ...
    var body: some View {
        ...
        VStack(spacing: 0) {
                ...
                LazyVStack(spacing: 0) {
                    ...
                    ForEach(visibleModels) { model in
                                    ...
                                    HStack(spacing: 6) {
                                        ...
                                        if model.isDefault {
                                            Text("default")
                                                ...
                                                .padding(.horizontal, 6)
                                                .padding(.vertical, 1)
                                                .background(BaoziTheme.accent.opacity(0.15))
                                                .clipShape(Capsule())
                                        }
                                    }
                        ...
                        if model.id != lastModelID {
                            Divider().background(BaoziTheme.separator).padding(.leading, 16)
                        }
                    }
                }
            }
            ...
            if isReasoningEffortLocked && selectedModelIsAmp {
                Divider().background(BaoziTheme.separator).padding(.horizontal, 12)
                        ...
                        ForEach(effectiveReasoningEfforts) { effort in
                            Button {
                                ...
                                Text(effort.reasoningEffort.wireValue)
                                    .baoziFont(.caption2, weight: .medium)
                                    .foregroundColor(effort.reasoningEffort.wireValue == reasoningEffort ? BaoziTheme.textOnAccent : BaoziTheme.textPrimary)
                                    .padding(.horizontal, 10)
                                    .padding(.vertical, 5)
                                    .background(effort.reasoningEffort.wireValue == reasoningEffort ? BaoziTheme.accent : BaoziTheme.surfaceLight)
                                    .clipShape(Capsule())
                            }
                        }
                    }
            ...
            HStack(spacing: 6) {
                Button {
                    ...
                    .foregroundColor(effectiveCollaborationMode == .plan ? .black : BaoziTheme.textPrimary)
                    .padding(.horizontal, 10)
                    .padding(.vertical, 5)
                    .background(effectiveCollaborationMode == .plan ? BaoziTheme.accent : BaoziTheme.surfaceLight)
                    .clipShape(Capsule())
                }
                ...
                Button {
                    ...
                    .foregroundColor(fastMode ? BaoziTheme.textOnAccent : BaoziTheme.textPrimary)
                    .padding(.horizontal, 10)
                    .padding(.vertical, 5)
                    .background(fastMode ? BaoziTheme.warning : BaoziTheme.surfaceLight)
                    .clipShape(Capsule())
                }
                ...
                if selectedRuntimeSupportsPermissionOverrides {
                    Button {
                        ...
                        .foregroundColor(isFullAccess ? BaoziTheme.textOnAccent : BaoziTheme.textPrimary)
                        .padding(.horizontal, 10)
                        .padding(.vertical, 5)
                        .background(isFullAccess ? BaoziTheme.danger : BaoziTheme.surfaceLight)
                        .clipShape(Capsule())
                    }
                }
        ...
        .padding(.vertical, 4)
        .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .top)
        .background(showsBackground ? BaoziTheme.surface : Color.clear)
        .onAppear {
        ...
        ScrollView {
            LazyVStack(spacing: 0) {
                ...
                ForEach(visibleModels) { model in
                    ...
                    Divider().background(BaoziTheme.separator).padding(.leading, 20)
                }
...
private struct RuntimeFilterPill: View {
    ...
    var body: some View {
        Button(action: onTap) {
            ...
            .baoziFont(.caption2, weight: .medium)
            .foregroundColor(selected ? BaoziTheme.textOnAccent : BaoziTheme.textPrimary)
            .padding(.horizontal, 10)
            .padding(.vertical, 5)
            .background(selected ? BaoziTheme.accent : BaoziTheme.surfaceLight)
            .clipShape(Capsule())
        }
        .buttonStyle(.plain)
    }
...
#if DEBUG
#Preview("Header") {
    let appModel = BaoziPreviewData.makeConversationAppModel()
    BaoziPreviewScene(appModel: appModel) {
