...
final class CarPlaySceneDelegate: UIResponder, CPTemplateApplicationSceneDelegate {
    private static let log = Logger(subsystem: "com.kris99.baozi", category: "CarPlay")
    ...
    func templateApplicationScene(
        ...
        let placeholder = CPGridTemplate(title: "Baozi", gridButtons: [Self.placeholderButton()])
