...
struct ConversationComposerContextBarView: View {
    ...
    var body: some View {
        ...
        .padding(.top, -2)
        .padding(.trailing, BaoziPlatform.isRegularSurface(horizontalSizeClass: horizontalSizeClass) ? 12 : 40)
    }
    ...
    private func contextTint(percent: Int64) -> Color {
        switch percent {
        case ...15: return BaoziTheme.danger
        case ...35: return BaoziTheme.warning
        default: return BaoziTheme.success
        }
    }
}
