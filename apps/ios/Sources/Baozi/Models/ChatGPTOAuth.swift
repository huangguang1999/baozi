...
enum ChatGPTOAuthError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .callbackTimedOut:
            return "ChatGPT login timed out before returning to Baozi."
        case .missingRefreshToken:
...
final class ChatGPTOAuthTokenStore {
    ...
    private let service = "com.kris99.baozi.chatgpt.tokens"
...
private final class ChatGPTOAuthLoopbackServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.kris99.baozi.chatgpt-oauth")
    ...
    private func processRequestData(_ data: Data, on connection: NWConnection) {
        ...
        sendResponse(
            ...
            body: "<html><body><h3>Login complete</h3><p>You can return to Baozi.</p></body></html>",
            on: connection
        )
