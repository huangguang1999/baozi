...
@MainActor
struct BaoziPreviewScene<Content: View>: View {
    ...
    init(
        ...
        _appModel = State(initialValue: appModel ?? BaoziPreviewData.makeConversationAppModel())
        _appState = State(initialValue: appState ?? BaoziPreviewData.makeAppState())
