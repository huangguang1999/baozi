...
extension View {
    func baoziFont(size: CGFloat, weight: Font.Weight = .regular) -> some View {
        modifier(ScaledSizeFontModifier(size: size, weight: weight))
    }

    func baoziFont(_ style: Font.TextStyle, weight: Font.Weight = .regular) -> some View {
        modifier(ScaledStyleFontModifier(style: style, weight: weight))
    }

    func baoziMonoFont(size: CGFloat, weight: Font.Weight = .regular) -> some View {
...
private struct ScaledSizeFontModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(BaoziFont.styled(size: size, weight: weight, scale: textScale))
    }
}
...
private struct ScaledStyleFontModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(BaoziFont.styled(style, weight: weight, scale: textScale))
    }
}
...
private struct ScaledMonoFontModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(BaoziFont.monospaced(size: size, weight: weight, scale: textScale))
    }
}
            ...
            content
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: cornerRadius)
                        .stroke((tint ?? BaoziTheme.border).opacity(0.4), lineWidth: 1)
                )
        }
    }
}
...
struct GlassRoundedRectModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        if #available(iOS 26.0, *) {
            ...
            content
                .background(BaoziTheme.surfaceLight)
