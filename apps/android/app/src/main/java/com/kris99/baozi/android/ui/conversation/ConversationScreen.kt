...
import com.kris99.baozi.android.state.isActiveStatus
import com.kris99.baozi.android.ui.BerkeleyMono
import com.kris99.baozi.android.ui.ChatWallpaperBackground
...
import com.kris99.baozi.android.ui.isNearListBottom
import com.kris99.baozi.android.ui.rememberStickyFollowTail
...
fun ConversationScreen(
    ...
    val warmMarkwon = remember(context) {
        try {
            val prism4j = io.noties.prism4j.Prism4j(com.kris99.baozi.android.ui.Prism4jGrammarLocator())
    ...
    val isMinigameActive = minigameOverlay !is com.kris99.baozi.android.state.MinigameOverlayState.Idle
    ...
    val dismissedUserInputs = com.kris99.baozi.android.ui.LocalDismissedUserInputs.current
    ...
    val headerScrimColor = if (hasWallpaper) BaoziTheme.surface.copy(alpha = 0.75f) else BaoziTheme.surface
        ...
        Column(
            ...
            Box(modifier = Modifier.weight(1f)) {
                if (thread == null) {
                    ...
                    val fadeColor = if (hasWallpaper) Color.Transparent else BaoziTheme.background
                                    ...
                                    Modifier.drawWithContent {
                                        ...
                                        drawRect(
                                            brush = Brush.verticalGradient(
                                                colors = listOf(BaoziTheme.background, Color.Transparent),
                                                startY = 0f,
                                                endY = 48f,
                                            ),
                                        )
                        ...
                        itemsIndexed(
                            ...
                            if (isExpanded) {
                                ...
                                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                                            ...
                                            is TimelineEntry.Single -> {
                                                ConversationTimelineItem(
                                                    ...
                                                    onWidgetPrompt = { text ->
                                                        scope.launch {
                                                            try {
                                                                val payload = com.kris99.baozi.android.state.AppComposerPayload(
                                                                    text = text,
                                    ...
                                    // Debug turn metrics
                                    if (com.kris99.baozi.android.state.DebugSettings.enabled && com.kris99.baozi.android.state.DebugSettings.showTurnMetrics) {
                                        ...
                                        Text(
                                            ...
                                            fontSize = 10f.scaled,
                                            fontFamily = com.kris99.baozi.android.ui.BerkeleyMono,
            ...
            if (!isMinigameActive) Column(modifier = Modifier.fillMaxWidth()) {
                ...
                val minigameFeatureOn = com.kris99.baozi.android.ui.ExperimentalFeatures.isEnabled(
                    com.kris99.baozi.android.ui.BaoziFeature.THINKING_MINIGAME,
                )
                ...
                Column(
                    ...
                    if (pinnedContext != null) {
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .background(BaoziTheme.codeBackground.copy(alpha = if (hasWallpaper) 0.75f else 1f))
                    ...
                    run {
                        ...
                        if (voiceLocalSession != null && voicePhase != null) {
                            com.kris99.baozi.android.ui.voice.InlineVoiceStatusStrip(
                                phase = voicePhase,
                        ...
                        onClick = {
                            scope.launch {
                                try {
                                    ...
                                    slashErrorMessage = e.message ?: "执行计划失败"
                                }
                            }
                        },
                    ) {
    ...
    Column(
        ...
        presets.forEach { preset ->
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .background(BaoziTheme.surface, RoundedCornerShape(16.dp))
...
private fun PlanContextBadge(progress: String) {
    Text(
        ...
        fontWeight = FontWeight.Medium,
        modifier = Modifier
            .background(BaoziTheme.surface.copy(alpha = 0.72f), RoundedCornerShape(999.dp))
...
private fun StreamingCursor() {
    ...
    val shimmerBrush = Brush.linearGradient(
        colors = listOf(
            BaoziTheme.textSecondary.copy(alpha = 0.4f),
            BaoziTheme.accent,
            BaoziTheme.textSecondary.copy(alpha = 0.4f),
        ),
...
private fun MinigameLaunchButton(onClick: () -> Unit) {
    androidx.compose.material3.Surface(
        ...
        color = BaoziTheme.surface.copy(alpha = 0.9f),
        border = androidx.compose.foundation.BorderStroke(0.5.dp, BaoziTheme.accent.copy(alpha = 0.3f)),
