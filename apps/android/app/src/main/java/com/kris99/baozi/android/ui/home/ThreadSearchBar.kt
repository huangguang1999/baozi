    ...
    Row(
        ...
        Row(
            modifier = rowModifier
                ...
                .background(
                    color = BaoziTheme.textPrimary.copy(alpha = 0.06f),
                    shape = CircleShape,
                )
                .border(
                    width = if (isExpanded) 1.dp else 0.5.dp,
                    color = if (isExpanded) BaoziTheme.accent.copy(alpha = 0.5f)
                    else BaoziTheme.textMuted.copy(alpha = 0.25f),
                    shape = CircleShape,
                )
            ...
            Icon(
                ...
                tint = if (isExpanded) BaoziTheme.accent else BaoziTheme.textSecondary,
